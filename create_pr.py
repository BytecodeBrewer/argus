...
payload = {"title": "Fix for issue #43", "body": "Closes #43\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-43", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/BytecodeBrewer/argus/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
