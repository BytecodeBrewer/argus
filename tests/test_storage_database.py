...
from argus.storage.database import initialize_database, insert_price_bar, read_price_bars
...
def test_data_is_inserted(tmp_path):
    ...
    price_bar_count = connection.execute(
...
def test_fx_has_correct_format(tmp_path):
    ...
    price_bar_fx = connection.execute(
